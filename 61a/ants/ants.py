...
class Place(object):
    ...
    def remove_insect(self, insect):
        ...
        """
        if insect.is_ant and insect.__class__ != QueenAnt:
        ...
        elif insect.__class__ == QueenAnt:
            if insect.impostor == True:
                self.ant = None
        else:
            self.bees.remove(insect)
        if insect.__class__ != QueenAnt:
            insect.place = None
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        while random_or_none(nearest_place.bees) == None:
            nearest_place = nearest_place.entrance
            if nearest_place == None:
                return None
...
class QueenAnt(ScubaThrower):  # You should change this line
    ...
    def action(self, colony):
        ...
        if self.impostor:
            ...
            place_behind = queens_place.exit
            while place_behind != None:
                new_ant = place_behind.ant
                if new_ant and new_ant not in self.ants_behind:
                    self.ants_behind.append(new_ant)
                    new_ant.damage *= 2 
